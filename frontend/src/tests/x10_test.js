...
// 1. НАСТРОЙКА ЭКСТРЕМАЛЬНОЙ НАГРУЗКИ ПО МЕТОДИЧКЕ (1200 VU на 15 минут)
export const options = {
  stages: [
    { duration: '5m', target: 1200 },  // Резкий разгон
    { duration: '15m', target: 1200 }, // Удержание пика 15 минут (серверу будет больно)
